...
- 60 张稳定编号 Ticket。
- T001～T011 为 DONE；T012 是当前唯一 READY Ticket；其余 Ticket 保持 PLANNED。
...
当前首个可执行项是 [T012：权限集合与默认拒绝 RBAC](T012-permission-rbac-enforcement.md)。T001～T011 已为 DONE，T012 的全部前置依赖均已完成，因此 T012 是当前唯一 READY Ticket。
